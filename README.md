...
Docker container that clones a GitHub repository containing a NodeJS web application. Build and runs the NodeJS application. Available as en open web service in [Eyevinn Open Source Cloud](https://docs.osaas.io/osaas.wiki/Service%3A-Web-Runner.html).
